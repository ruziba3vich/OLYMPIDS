...
var file_auth_service_auth_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xc1, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
...
var file_auth_service_auth_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: athlete.RegisterRequest
	(*RegisterResponse)(nil), // 1: athlete.RegisterResponse
	(*LoginRequest)(nil),     // 2: athlete.LoginRequest
	(*LoginResponse)(nil),    // 3: athlete.LoginResponse
	(*LogoutRequest)(nil),    // 4: athlete.LogoutRequest
	(*LogoutResponse)(nil),   // 5: athlete.LogoutResponse
}
var file_auth_service_auth_proto_depIdxs = []int32{
	0, // 0: athlete.AuthService.Register:input_type -> athlete.RegisterRequest
	2, // 1: athlete.AuthService.Login:input_type -> athlete.LoginRequest
	4, // 2: athlete.AuthService.Logout:input_type -> athlete.LogoutRequest
	1, // 3: athlete.AuthService.Register:output_type -> athlete.RegisterResponse
	3, // 4: athlete.AuthService.Login:output_type -> athlete.LoginResponse
	5, // 5: athlete.AuthService.Logout:output_type -> athlete.LogoutResponse
