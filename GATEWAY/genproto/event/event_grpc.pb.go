...
const (
	...
	EventService_GetEventBySport_FullMethodName = "/event.EventService/GetEventBySport"
)
...
func (c *eventServiceClient) GetEventBySport(ctx context.Context, in *GetEventBySportRequest, opts ...grpc.CallOption) (*GetEventBySportResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_GetEventBySport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventService_GetEventBySport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_GetEventBySport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
